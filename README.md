...
The author grants the public limited permission to freely read, download, and retain unaltered copies of this work solely for personal non-commercial use via this repository.
Without the author’s written consent, the following acts are prohibited:
Altering, writing sequels to, translating, abridging, or creating derivative works based on this text;
